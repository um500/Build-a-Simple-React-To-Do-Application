    ...
    <div className="absolute z-10 w-[215px] shadow bg-white top-8 left-0 max-xl:-left-48 p-3 rounded-2xl">
      <ul className=" flex flex-col text-black">
        ...
        >
          ...
          >
            <RiEdit2Fill className=" text-2xl max-sm:text-xl text-black" />
            Edit
          </Link>
        </li>
        <li
          ...
          className="max-sm:text-sm flex items-center gap-2 cursor-pointer hover:bg-slate-100 py-3 px-2 rounded-md"
        >
          <MdContentCopy className=" text-2xl max-sm:text-xl text-black" />
          Copy
        </li>
        <li
          ...
          className="max-sm:text-sm flex items-center gap-2 cursor-pointer hover:bg-slate-100 py-3 px-2 rounded-md"
        >
          <MdDelete className=" text-2xl max-sm:text-xl text-black" />
          Delete
        </li>
        <li>
          <Link
            ...
            className=" max-sm:text-sm flex items-center gap-2 cursor-pointer hover:bg-slate-100 py-3 px-2 rounded-md"
          >
            <BiTask className=" text-2xl max-sm:text-xl text-black" />
            Task details
          </Link>
        </li>
      </ul>
